...
class BanditTesSetTests(testtools.TestCase):
    ...
    def test_profile_has_builtin_blacklist(self):
        ...
        self.assertEqual(1, len(ts.get_tests('Calls')))
    ...
    def test_profile_exclude_builtin_blacklist(self):
        ...
        self.assertEqual(0, len(ts.get_tests('Calls')))
    ...
    def test_profile_filter_blacklist_none(self):
        ...
        self.assertEqual(2, len(blacklist._config['Calls']))
    ...
    def test_profile_filter_blacklist_one(self):
        ...
        self.assertEqual(1, len(blacklist._config['Calls']))
