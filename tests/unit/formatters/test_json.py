...
class JsonFormatterTests(testtools.TestCase):
    def setUp(self):
        ...
        self.issue = issue.Issue(
            bandit.MEDIUM, issue.Cwe.MULTIPLE_BINDS, bandit.MEDIUM, "Possible binding to all interfaces."
        )

        self.candidates = [
            issue.Issue(issue.Cwe.MULTIPLE_BINDS, bandit.LOW, bandit.LOW, "Candidate A", lineno=1),
            issue.Issue(bandit.HIGH, issue.Cwe.MULTIPLE_BINDS, bandit.HIGH, "Candiate B", lineno=2),
        ]
